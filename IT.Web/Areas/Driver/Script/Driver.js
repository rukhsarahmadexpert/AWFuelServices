...
$('#updateDriver').click(function () {
    ...
    ajaxRequest("POST", "/DriverUpdateCustomer", Data, "json").then(function (result) {
        if (result);
        {
            ClearDriver();
            sucessUpdate();
...
$('#saveDriver').click(function () {
    ...
    if (IsValidDriver()) {
        ...
        ajaxRequest("POST", "/Driver-Create", Data, "json").then(function (result) {
            if (result);
            {
                ClearDriver();
...
function View(Id) {
    window.location.href = '/Driver-Details/' + Id;
}
