function Edit(Id) {
    ...
    ajaxRequest("GET", "/AWFEmployee-Edit/" + Id, "", "json").then(function (result) {
        if (result) {
            $('select').chosen();
...
$('#saveEmployee').click(function () {
    ...
    if (ValidEmployee()) {
        ...
        ajaxRequest("POST", "AWFEmployee-Create", Data, "json").then(function (result) {
...
$('#updateEmployee').click(function () {
    ...
    if (ValidEmployee) {
        ...
        ajaxRequest("POST", "AWFEmployee-Update", Data, "json").then(function (result) {
